...
#include "purpleTentacleMonster.h"
...
void initPurpleTentacleMonster(Entity *e)
{
	Monster *m;
	...
	if (textures[0] == NULL)
	{
		textures[0] = getAtlasImage("gfx/entities/purpleTentacleMonster1.png", 1);
		textures[1] = getAtlasImage("gfx/entities/purpleTentacleMonster2.png", 1);
	}

	e->typeName = "purpleTentacleMonster";
